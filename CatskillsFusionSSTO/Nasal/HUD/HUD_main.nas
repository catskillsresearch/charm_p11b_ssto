...
var STSHUD = {
	...
	data = SpaceShuttle.draw_ladder (40, 2, 0.09, 3, 0.09, 0, 0 , 1);
	...
	data = SpaceShuttle.draw_ladder (40, 2, 0.09, 3, 0.09, 0, 1 , 1);
	...
	obj.dc2.sb_indicator.setTranslation (140, 180);  
	...
	obj.dc2.horizon.line1 = obj.dc2.horizon.createChild("path", "plot_horizonL")
        .setStrokeLineWidth(0.8 * hud_thickness)
        .setColor(hud_color);
	...
	data = SpaceShuttle.draw_ladder (4050, 37, 0.0025, 0, 0.09, 1, 0 , 0);

	obj.dc1.pitch_ladder.ladder1 = obj.dc1.pitch_ladder.createChild("path", "plot_PLadder1")
        .setStrokeLineWidth(1.3 * hud_thickness)
	...
	data = SpaceShuttle.draw_ladder (1912.5, 18, 0.0025, 0, 0.09, 1, 1 , 2);
	...
	data = SpaceShuttle.draw_ladder (1912.5, 18, 0.0025, 0, 0.09, 1, 0 , 2);
...
var HUD_DataProvider  = {
	...
	if ((me.radar_alt_available == 1) and (me.alt_agl_ft < 5000.0))
		...
		{
		if (SpaceShuttle.TAEM_guidance_available == 0) {me.altitude_ft =  me.nd_ref_alt.getValue();} #Alt QNH without runway elevation
		else {me.altitude_ft =  me.nd_ref_alt.getValue() - SpaceShuttle.TAEM_threshold.elevation;} #Alt QFE with TAEM guidance
		}
...
settimer( func {hudrtExec_loop();}, 1.0);
