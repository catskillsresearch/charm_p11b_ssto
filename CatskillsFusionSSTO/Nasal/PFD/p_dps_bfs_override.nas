...
var PFD_addpage_p_dps_bfs_override = func(device)
{
	...
	# RCS dumps
        ...
        p_dps_bfs_override.frcs_ttg.updateText(sprintf("%03d", getprop("/fdm/jsbsim/systems/rcs/fwd-dump-time-s")));
        p_dps_bfs_override.arcs_ttg.updateText(sprintf("%03d", getprop("/fdm/jsbsim/systems/rcs/aft-dump-time-s")));
...
symbol = "";
        ...
        p_dps_bfs_override.omsdump_qty.updateText(sprintf("%03d", getprop("/fdm/jsbsim/systems/oms/oms-dump-qty")));
        p_dps_bfs_override.omsdump_ttg.updateText(sprintf("%03d", getprop("/fdm/jsbsim/systems/oms/oms-dump-ttg-s")));
