...
var PFD_addpage_p_dps_cryo = func(device)
{
	...
	var spec_string = assemble_spec_string(spec);
        ...
        var ops_string = major_mode~"1/"~spec_string~"/068";  
    ...
    #Simple placeholder for cryo valve state depending on switch position

    var O2_manf_v1 = getprop("/fdm/jsbsim/systems/dummy/switch/o2-man-valve-1");
    var O2_manf_v2 = getprop("/fdm/jsbsim/systems/dummy/switch/o2-man-valve-2");
    var H2_manf_v1 = getprop("/fdm/jsbsim/systems/dummy/switch/h2-man-valve-1");
    var H2_manf_v2 = getprop("/fdm/jsbsim/systems/dummy/switch/h2-man-valve-2");

    #O2
    if (O2_manf_v1 == 0) {p_dps_cryo.o2_vlv_1.setText("CL");}
    else {p_dps_cryo.o2_vlv_1.setText("OP");}

    if (O2_manf_v2 == 0) {p_dps_cryo.o2_vlv_2.setText("CL");}
    else {p_dps_cryo.o2_vlv_2.setText("OP");}

    #H2
    if (H2_manf_v1 == 0) {p_dps_cryo.h2_vlv_1.setText("CL");}
    else {p_dps_cryo.h2_vlv_1.setText("OP");}

    if (H2_manf_v2 == 0) {p_dps_cryo.h2_vlv_2.setText("CL");}
    else {p_dps_cryo.h2_vlv_2.setText("OP");}
