...
var PFD_addpage_p_dps_imu_align = func(device)
{
	...
	p_dps_imu_align.imu1_acc_x.updateText(sprintf("%+05.2f", acc_x + SpaceShuttle.imu_system.imu[0].acc_error_x));
	p_dps_imu_align.imu2_acc_x.updateText(sprintf("%+05.2f", acc_x + SpaceShuttle.imu_system.imu[1].acc_error_x));
	p_dps_imu_align.imu3_acc_x.updateText(sprintf("%+05.2f", acc_x + SpaceShuttle.imu_system.imu[2].acc_error_x));

	p_dps_imu_align.imu1_acc_y.updateText(sprintf("%+05.2f", acc_y + SpaceShuttle.imu_system.imu[0].acc_error_y));
	p_dps_imu_align.imu2_acc_y.updateText(sprintf("%+05.2f", acc_y + SpaceShuttle.imu_system.imu[1].acc_error_y));
	p_dps_imu_align.imu3_acc_y.updateText(sprintf("%+05.2f", acc_y + SpaceShuttle.imu_system.imu[2].acc_error_y));

	p_dps_imu_align.imu1_acc_z.updateText(sprintf("%+05.2f", acc_z + SpaceShuttle.imu_system.imu[0].acc_error_z));
	p_dps_imu_align.imu2_acc_z.updateText(sprintf("%+05.2f", acc_z + SpaceShuttle.imu_system.imu[1].acc_error_z));
	p_dps_imu_align.imu3_acc_z.updateText(sprintf("%+05.2f", acc_z + SpaceShuttle.imu_system.imu[2].acc_error_z));
	...
	p_dps_imu_align.imu1_ang_x.setText(sprintf("%06.2f", m50_roll + SpaceShuttle.imu_system.imu[0].roll_error));
	p_dps_imu_align.imu2_ang_x.setText(sprintf("%06.2f", m50_roll + SpaceShuttle.imu_system.imu[1].roll_error));
	p_dps_imu_align.imu3_ang_x.setText(sprintf("%06.2f", m50_roll + SpaceShuttle.imu_system.imu[2].roll_error));

	p_dps_imu_align.imu1_ang_y.setText(sprintf("%06.2f", m50_pitch + SpaceShuttle.imu_system.imu[0].pitch_error));
	p_dps_imu_align.imu2_ang_y.setText(sprintf("%06.2f", m50_pitch + SpaceShuttle.imu_system.imu[1].pitch_error));
	p_dps_imu_align.imu3_ang_y.setText(sprintf("%06.2f", m50_pitch + SpaceShuttle.imu_system.imu[2].pitch_error));

	p_dps_imu_align.imu1_ang_z.setText(sprintf("%06.2f", m50_yaw + SpaceShuttle.imu_system.imu[0].yaw_error));
	p_dps_imu_align.imu2_ang_z.setText(sprintf("%06.2f", m50_yaw + SpaceShuttle.imu_system.imu[1].yaw_error));
	p_dps_imu_align.imu3_ang_z.setText(sprintf("%06.2f", m50_yaw + SpaceShuttle.imu_system.imu[2].yaw_error));
	...
	if (SpaceShuttle.imu_system.align_enable == 0)
		...
		p_dps_imu_align.imu1_delta_x.updateText("+000.00");
		p_dps_imu_align.imu2_delta_x.updateText("+000.00");
		p_dps_imu_align.imu3_delta_x.updateText("+000.00");

		p_dps_imu_align.imu1_delta_y.updateText("+000.00");
		p_dps_imu_align.imu2_delta_y.updateText("+000.00");
		p_dps_imu_align.imu3_delta_y.updateText("+000.00");

		p_dps_imu_align.imu1_delta_z.updateText("+000.00");
		p_dps_imu_align.imu2_delta_z.updateText("+000.00");
		p_dps_imu_align.imu3_delta_z.updateText("+000.00");
		}
	else
		{
		p_dps_imu_align.ena.updateText("ENA");

		p_dps_imu_align.imu1_delta_x.updateText(sprintf("%+07.2f",SpaceShuttle.imu_system.imu[0].delta_roll ));
		p_dps_imu_align.imu2_delta_x.updateText(sprintf("%+07.2f",SpaceShuttle.imu_system.imu[1].delta_roll ));
		p_dps_imu_align.imu3_delta_x.updateText(sprintf("%+07.2f",SpaceShuttle.imu_system.imu[2].delta_roll ));

		p_dps_imu_align.imu1_delta_y.updateText(sprintf("%+07.2f",SpaceShuttle.imu_system.imu[0].delta_pitch ));
		p_dps_imu_align.imu2_delta_y.updateText(sprintf("%+07.2f",SpaceShuttle.imu_system.imu[1].delta_pitch ));
		p_dps_imu_align.imu3_delta_y.updateText(sprintf("%+07.2f",SpaceShuttle.imu_system.imu[2].delta_pitch ));

		p_dps_imu_align.imu1_delta_z.updateText(sprintf("%+07.2f",SpaceShuttle.imu_system.imu[0].delta_yaw ));
		p_dps_imu_align.imu2_delta_z.updateText(sprintf("%+07.2f",SpaceShuttle.imu_system.imu[1].delta_yaw ));
		p_dps_imu_align.imu3_delta_z.updateText(sprintf("%+07.2f",SpaceShuttle.imu_system.imu[2].delta_yaw ));
		}
