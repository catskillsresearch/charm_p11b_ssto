...
var PFD_addpage_p_dps_pdrs_control = func(device)
{
	...
	p_dps_pdrs_control.endpos_x.setText(sprintf("%+08.2f",SpaceShuttle.pdrs_auto_seq_manager.opr_cmd_tgt[0]));
	p_dps_pdrs_control.endpos_y.setText(sprintf("%+08.2f",SpaceShuttle.pdrs_auto_seq_manager.opr_cmd_tgt[1]));
	p_dps_pdrs_control.endpos_z.setText(sprintf("%+08.2f",SpaceShuttle.pdrs_auto_seq_manager.opr_cmd_tgt[2]));

	p_dps_pdrs_control.endatt_p.setText(sprintf("%+07.2f",SpaceShuttle.pdrs_auto_seq_manager.opr_cmd_tgt[3]));
	p_dps_pdrs_control.endatt_y.setText(sprintf("%+07.2f",SpaceShuttle.pdrs_auto_seq_manager.opr_cmd_tgt[4]));
	p_dps_pdrs_control.endatt_r.setText(sprintf("%+07.2f",SpaceShuttle.pdrs_auto_seq_manager.opr_cmd_tgt[5]));

	p_dps_pdrs_control.pl_id.setText(sprintf("%2d", getprop("/fdm/jsbsim/systems/rms/software/pl-id")));
	p_dps_pdrs_control.pl_init_id.setText(sprintf("%2d", getprop("/fdm/jsbsim/systems/rms/software/pl-init-id")));
	...
	if (SpaceShuttle.pdrs_auto_seq_manager.sequence_slot_array[0] > -1)
		{p_dps_pdrs_control.auto_1.setText(sprintf("%2d", SpaceShuttle.pdrs_auto_seq_manager.sequence_slot_array[0] + 1));}
	else
		{p_dps_pdrs_control.auto_1.setText("");}

	if (SpaceShuttle.pdrs_auto_seq_manager.sequence_slot_array[1] > -1)
		{p_dps_pdrs_control.auto_2.setText(sprintf("%2d", SpaceShuttle.pdrs_auto_seq_manager.sequence_slot_array[1] + 1 ));}
	else
		{p_dps_pdrs_control.auto_2.setText("");}

	if (SpaceShuttle.pdrs_auto_seq_manager.sequence_slot_array[2] > -1)
		{p_dps_pdrs_control.auto_3.setText(sprintf("%2d", SpaceShuttle.pdrs_auto_seq_manager.sequence_slot_array[2] + 1));}
	else
		{p_dps_pdrs_control.auto_3.setText("");}

	if (SpaceShuttle.pdrs_auto_seq_manager.sequence_slot_array[3] > -1)
		{p_dps_pdrs_control.auto_4.setText(sprintf("%2d", SpaceShuttle.pdrs_auto_seq_manager.sequence_slot_array[3] + 1));}
	else
	...
	if (current_point > 0)
		{
		p_dps_pdrs_control.last_pt.setText(sprintf("%3d", current_point ));
		}
	else
		{
	...
	p_dps_pdrs_control.start_pt.setText(sprintf("%3d", SpaceShuttle.pdrs_auto_seq_manager.start_index +1 ));
