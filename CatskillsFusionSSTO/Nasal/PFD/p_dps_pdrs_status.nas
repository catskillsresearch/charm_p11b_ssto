...
var PFD_addpage_p_dps_pdrs_status = func(device)
{
	...
	p_dps_pdrs_status.por_ref_sel.setText("ORB");
    	...
    	p_dps_pdrs_status.att_err.setText("0.000");
	...
	# joint angles
    	...
    	p_dps_pdrs_status.ang_sy.setText(sprintf("%+7.2f", getprop("/fdm/jsbsim/systems/rms/ang-shoulder-yaw-deg")));
    	p_dps_pdrs_status.ang_sp.setText(sprintf("%+7.2f", getprop("/fdm/jsbsim/systems/rms/ang-shoulder-pitch-deg")));
    	p_dps_pdrs_status.ang_ep.setText(sprintf("%+7.2f", getprop("/fdm/jsbsim/systems/rms/ang-ellbow-pitch-deg")));
    	p_dps_pdrs_status.ang_wp.setText(sprintf("%+7.2f", getprop("/fdm/jsbsim/systems/rms/ang-wrist-pitch-deg"))); 
    	p_dps_pdrs_status.ang_wy.setText(sprintf("%+7.2f", getprop("/fdm/jsbsim/systems/rms/ang-wrist-yaw-deg")));
    	p_dps_pdrs_status.ang_wr.setText(sprintf("%+7.2f", getprop("/fdm/jsbsim/systems/rms/ang-wrist-roll-deg")));
	...
	var pos_z = getprop("/fdm/jsbsim/systems/rms/effector-z") * 39.37;
    	...
    	p_dps_pdrs_status.pohs_pref_x.setText(sprintf("%+6.0f", pos_x));
    	p_dps_pdrs_status.pohs_pref_y.setText(sprintf("%+6.0f", pos_y));
    	p_dps_pdrs_status.pohs_pref_z.setText(sprintf("%+6.0f", pos_z));

	p_dps_pdrs_status.pos_x.setText(sprintf("%+6.0f", pos_x));
	p_dps_pdrs_status.pos_y.setText(sprintf("%+6.0f", pos_y));
	p_dps_pdrs_status.pos_z.setText(sprintf("%+6.0f", pos_z));
	...
	var z_rate = getprop("/fdm/jsbsim/systems/rms/ma/z-rate") / 0.3048;
    	...
    	p_dps_pdrs_status.trate_cmd_x.setText(sprintf("%+6.2f", x_rate));
    	p_dps_pdrs_status.trate_cmd_y.setText(sprintf("%+6.2f", y_rate));
    	p_dps_pdrs_status.trate_cmd_z.setText(sprintf("%+6.2f", z_rate));

    	p_dps_pdrs_status.trate_act_x.setText(sprintf("%+6.2f", x_rate));
    	p_dps_pdrs_status.trate_act_y.setText(sprintf("%+6.2f", y_rate));
    	p_dps_pdrs_status.trate_act_z.setText(sprintf("%+6.2f", z_rate));
	...
	var att_r = getprop("/fdm/jsbsim/systems/rms/ang-wrist-roll-deg");
    	...
    	p_dps_pdrs_status.pohs_aref_p.setText(sprintf("%+6.1f", att_p));
    	p_dps_pdrs_status.pohs_aref_y.setText(sprintf("%+6.1f", att_y));
    	p_dps_pdrs_status.pohs_aref_r.setText(sprintf("%+6.1f", att_r));

    	p_dps_pdrs_status.att_p.setText(sprintf("%+6.1f", att_p));
    	p_dps_pdrs_status.att_y.setText(sprintf("%+6.1f", att_y));
    	p_dps_pdrs_status.att_r.setText(sprintf("%+6.1f", att_r));
	...
	var roll_rate = getprop("/fdm/jsbsim/systems/rms/ma/roll-rate");
    	...
    	p_dps_pdrs_status.rrate_act_p.setText(sprintf("%+6.2f", pitch_rate));
    	p_dps_pdrs_status.rrate_act_y.setText(sprintf("%+6.2f", yaw_rate));
    	p_dps_pdrs_status.rrate_act_r.setText(sprintf("%+6.2f", roll_rate));

    	p_dps_pdrs_status.rrate_cmd_p.setText(sprintf("%+6.2f", pitch_rate));
    	p_dps_pdrs_status.rrate_cmd_y.setText(sprintf("%+6.2f", yaw_rate)); 
    	p_dps_pdrs_status.rrate_cmd_r.setText(sprintf("%+6.2f", roll_rate));
	...
	p_dps_pdrs_status.ee_rigid.setText(sprintf("%1d", effector_rigid));   
    	p_dps_pdrs_status.ee_derig.setText(sprintf("%1d", 1 - effector_rigid));  

    	p_dps_pdrs_status.ee_close.setText(sprintf("%1d", effector_closed));  
    	p_dps_pdrs_status.ee_open.setText(sprintf("%1d", 1 - effector_closed));  

    	p_dps_pdrs_status.ee_capture.setText(sprintf("%1d", effector_attached));  
    	p_dps_pdrs_status.ee_extend.setText(sprintf("%1d", 1-effector_attached));  
