...
var PFD_addpage_p_dps_rcs = func(device)
{
	...
	p_dps_rcs.press.setText("ENA");
    	...
    	p_dps_rcs.oms_rcs_qty_l.setText("00 00");
    	p_dps_rcs.oms_rcs_qty_r.setText("00 00");
	...
	if (table_index == 1) # forward jets
		...
		p_dps_rcs.he_p_oxid.setText(sprintf("%4.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/helium-fwd-rcs-pressure-1-sh-psia"))); 
    		...
    		p_dps_rcs.tk_p_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/tanks-fwd-rcs-blowdown-psia")));
    		p_dps_rcs.tk_p_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/tanks-fwd-rcs-blowdown-psia")));

    		p_dps_rcs.tk_t_oxid.setText(" 80");
   		p_dps_rcs.tk_t_fu.setText(" 80"); 

    		p_dps_rcs.tk_qty_oxid.setText(sprintf("%3.0f", getprop("/consumables/fuel/tank[12]/level-lbs")/14.770)); 
    		p_dps_rcs.tk_qty_fu.setText(sprintf("%3.0f", getprop("/consumables/fuel/tank[13]/level-lbs")/9.280));

   		p_dps_rcs.manf_p1_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/fwd-mfold1-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p1_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/fwd-mfold1-fuel-pressure-psia")));

   		p_dps_rcs.manf_p2_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/fwd-mfold2-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p2_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/fwd-mfold2-fuel-pressure-psia"))); 

   		p_dps_rcs.manf_p3_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/fwd-mfold3-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p3_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/fwd-mfold3-fuel-pressure-psia")));

   		p_dps_rcs.manf_p4_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/fwd-mfold4-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p4_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/fwd-mfold4-fuel-pressure-psia"))); 
		...
		p_dps_rcs.he_p_oxid.setText(sprintf("%4.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/helium-left-rcs-pressure-1-sh-psia")));
    		...
    		p_dps_rcs.tk_p_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/tanks-left-rcs-blowdown-psia")));
    		p_dps_rcs.tk_p_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/tanks-left-rcs-blowdown-psia")));

    		p_dps_rcs.tk_t_oxid.setText(" 80");
   		p_dps_rcs.tk_t_fu.setText(" 80");

    		p_dps_rcs.tk_qty_oxid.setText(sprintf("%3.0f", getprop("/consumables/fuel/tank[8]/level-lbs")/14.770)); 
    		p_dps_rcs.tk_qty_fu.setText(sprintf("%3.0f", getprop("/consumables/fuel/tank[9]/level-lbs")/9.280)); 

   		p_dps_rcs.manf_p1_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/left-mfold1-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p1_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/left-mfold1-fuel-pressure-psia")));

   		p_dps_rcs.manf_p2_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/left-mfold2-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p2_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/left-mfold2-fuel-pressure-psia"))); 

   		p_dps_rcs.manf_p3_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/left-mfold3-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p3_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/left-mfold3-fuel-pressure-psia")));

   		p_dps_rcs.manf_p4_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/left-mfold4-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p4_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/left-mfold4-fuel-pressure-psia"))); 
		...
		p_dps_rcs.he_p_oxid.setText(sprintf("%4.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/helium-right-rcs-pressure-1-sh-psia")));
    		...
    		p_dps_rcs.tk_p_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/tanks-right-rcs-blowdown-psia")));
    		p_dps_rcs.tk_p_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/tanks-right-rcs-blowdown-psia")));

    		p_dps_rcs.tk_t_oxid.setText(" 80"); 
   		p_dps_rcs.tk_t_fu.setText(" 80"); 

    		p_dps_rcs.tk_qty_oxid.setText(sprintf("%3.0f", getprop("/consumables/fuel/tank[10]/level-lbs")/14.770)); 
    		p_dps_rcs.tk_qty_fu.setText(sprintf("%3.0f", getprop("/consumables/fuel/tank[11]/level-lbs")/9.280));

   		p_dps_rcs.manf_p1_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/right-mfold1-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p1_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/right-mfold1-fuel-pressure-psia")));

   		p_dps_rcs.manf_p2_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/right-mfold2-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p2_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/right-mfold2-fuel-pressure-psia"))); 

   		p_dps_rcs.manf_p3_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/right-mfold3-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p3_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/right-mfold3-fuel-pressure-psia")));

   		p_dps_rcs.manf_p4_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/right-mfold4-oxidizer-pressure-psia")));
    		p_dps_rcs.manf_p4_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/right-mfold4-fuel-pressure-psia"))); 
    	...
    	p_dps_rcs.xfeedp_oxid.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/xfeed-oxidizer-pressure-psia")));
   	p_dps_rcs.xfeedp_fu.setText(sprintf("%3.0f", getprop("/fdm/jsbsim/systems/rcs-hardware/xfeed-fuel-pressure-psia")));
