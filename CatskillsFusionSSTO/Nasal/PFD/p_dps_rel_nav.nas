...
var PFD_addpage_p_dps_rel_nav = func(device)
{
	...
	p_dps_rel_nav.gps_1s_p.setText("  175");
	p_dps_rel_nav.gps_2s_p.setText("  250");
	p_dps_rel_nav.gps_3s_p.setText("   75");
	...
	p_dps_rel_nav.hazx_acpt.setText("");
   	...
   	p_dps_rel_nav.gps1_x.setText("P"); #Position	
   	p_dps_rel_nav.gps2_x.setText("V"); #Velocity
	...
	#Clamp function for value that can get really high ( higher than the lenght defined in SCOM and sprintf ------> messing up the display then)
	#Clamp function to be put after the sprint transformation in case + sign is forced ( %+ ------> if not, "not numerical string" error)
	...
	if (SpaceShuttle.proximity_manager.rel_nav_enable == 0)
		...
		if (SpaceShuttle.proximity_manager.sv_selection == 0)
			{
			p_dps_rel_nav.rng_prop.setText(sprintf("%8.3f", SpaceShuttle.clamp(range_prop / 1000 / 0.3048, 0000.000, 9999.999)));
			p_dps_rel_nav.rdot_prop.setText(sprintf("%+8.2f", SpaceShuttle.clamp(rdot_prop / 0.3048, -9999.99, 9999.99)));
			p_dps_rel_nav.theta_prop.setText(sprintf("%6.2f", theta_prop));
    			p_dps_rel_nav.y_prop.setText(sprintf("%+6.2f", SpaceShuttle.clamp( Y_prop/1000. / 0.3048, -99.99, 99.99)));
    			p_dps_rel_nav.ydot_prop.setText(sprintf("%+6.1f", SpaceShuttle.clamp( Ydot_prop / 0.3048, -999.9, 999.9)));
			}
		else
			{
			p_dps_rel_nav.rng_prop.setText(sprintf("%8.3f", SpaceShuttle.clamp(range_filtered / 1000. / 0.3048, 0000.000, 9999.999)));
			p_dps_rel_nav.rdot_prop.setText(sprintf("%+8.2f", SpaceShuttle.clamp( rdot_filtered / 0.3048, -9999.99, 9999.99)));
			p_dps_rel_nav.theta_prop.setText(sprintf("%6.2f", theta_filtered));
    			p_dps_rel_nav.y_prop.setText(sprintf("%+6.2f", SpaceShuttle.clamp( Y_filtered/1000. / 0.3048, -99.99, 99.99)));
    			p_dps_rel_nav.ydot_prop.setText(sprintf("%+6.1f", SpaceShuttle.clamp(Ydot_filtered / 0.3048, -999.9, 999.9)));
			}
		...
		p_dps_rel_nav.sv_trans_vel.setText(sprintf("%+06.2f", v_fltr_minus_prop / 0.3048));

		#var pos_e = getprop("/fdm/jsbsim/systems/navigation/state-vector/error-rndz/pos-m");

		#var pos_fltr_minus_prop = pos_e;
		p_dps_rel_nav.sv_trans_pos.setText(sprintf("%+06.2f", pos_fltr_minus_prop / 1000. /0.3048));
		}
	...
	if ((antenna_func == "COMM") or (ku_enable == 0))
		...
		p_dps_rel_nav.rng_ku.setText("");
		p_dps_rel_nav.rdot_ku.setText("");
		p_dps_rel_nav.el_ku.setText(sprintf("%+6.1f", ku_elevation_body));
    		p_dps_rel_nav.az_ku.setText(sprintf("%+6.1f", ku_azimuth_body));
    		p_dps_rel_nav.omega_p_ku.setText("");
    		p_dps_rel_nav.omega_r_ku.setText("");
		}
	else
		...
		p_dps_rel_nav.rng_ku.setText(sprintf("%8.3f", SpaceShuttle.clamp(range_sensed / 1000. / 0.3048, 0000.000, 9999.999)));
		p_dps_rel_nav.rdot_ku.setText(sprintf("%+8.2f",SpaceShuttle.clamp( rdot / 0.3048, -9999.99, 9999.99)));
		p_dps_rel_nav.el_ku.setText(sprintf("%+6.1f", ku_elevation_body));
    		p_dps_rel_nav.az_ku.setText(sprintf("%+6.1f", ku_azimuth_body));

		p_dps_rel_nav.omega_p_ku.setText(sprintf("%+5.1f", omega_p_ku));
		p_dps_rel_nav.omega_r_ku.setText(sprintf("%+5.1f", omega_r_ku));
		}		
	...
	if (SpaceShuttle.proximity_manager.rel_nav_enable == 0)
		...
		if (SpaceShuttle.proximity_manager.ang_data_good == 1)
			{
			p_dps_rel_nav.vely_resid.setText(sprintf("%+05.2f",  SpaceShuttle.clamp(SpaceShuttle.proximity_manager.y_resid, -9.99, 9.99)));
			p_dps_rel_nav.vely_ratio.setText(sprintf("%03.1f",  SpaceShuttle.clamp(SpaceShuttle.proximity_manager.y_ratio  , 0.0, 9.9)));

			p_dps_rel_nav.hazx_resid.setText(sprintf("%+05.2f",  SpaceShuttle.clamp(SpaceShuttle.proximity_manager.z_resid, -9.99, 9.99)));
			p_dps_rel_nav.hazx_ratio.setText(sprintf("%03.1f",  SpaceShuttle.clamp(SpaceShuttle.proximity_manager.z_ratio, 0.0, 9.9)));
			}
		else
			{
			p_dps_rel_nav.vely_resid.setText("");
		...
		if (SpaceShuttle.proximity_manager.rr_data_good == 1)
			{
			p_dps_rel_nav.rng_resid.setText(sprintf("%+06.2f", SpaceShuttle.clamp(SpaceShuttle.proximity_manager.rng_resid, -99.99, 99.99)));
			p_dps_rel_nav.rng_ratio.setText(sprintf("%03.1f", SpaceShuttle.clamp(SpaceShuttle.proximity_manager.rng_ratio, 0.0, 9.9)));

			p_dps_rel_nav.rdot_resid.setText(sprintf("%+06.2f", SpaceShuttle.clamp(SpaceShuttle.proximity_manager.rdot_resid, -99.99, 99.99)));
			p_dps_rel_nav.rdot_ratio.setText(sprintf("%03.1f", SpaceShuttle.clamp(SpaceShuttle.proximity_manager.rdot_ratio, 0, 9.9)));
  		...
  		p_dps_rel_nav.gps1_resid.setText(sprintf("%+07.2f", SpaceShuttle.clamp(SpaceShuttle.proximity_manager.gps_p_resid, -999.99, 999.99)));
    		p_dps_rel_nav.gps2_resid.setText(sprintf("%+07.2f", SpaceShuttle.clamp(SpaceShuttle.proximity_manager.gps_v_resid, -999.99, 999.99)));
    		p_dps_rel_nav.gps1_ratio.setText(sprintf("%03.1f", SpaceShuttle.clamp(SpaceShuttle.proximity_manager.gps_p_ratio, 0, 9.9)));
    		p_dps_rel_nav.gps2_ratio.setText(sprintf("%03.1f", SpaceShuttle.clamp(SpaceShuttle.proximity_manager.gps_v_ratio, 0, 9.9)));
	...
	p_dps_rel_nav.update_pos.setText(sprintf("%05.2f", update_pos / 1000. / 0.3048));
	p_dps_rel_nav.update_vel.setText(sprintf("%05.2f", update_vel / 0.3048));
	...
	if (selected_tracker > -1)
		...
		if ((selected_tracker == 1) and (SpaceShuttle.star_tracker_array[1].status == ""))
			{
			p_dps_rel_nav.stat_x.setText(sprintf("%+04.1f", SpaceShuttle.star_tracker_array[1].offset_angle_x * 180/math.pi));
			p_dps_rel_nav.stat_y.setText(sprintf("%+04.1f", SpaceShuttle.star_tracker_array[1].offset_angle_y * 180/math.pi));
			}
		else
			{
			p_dps_rel_nav.stat_x.setText("");
