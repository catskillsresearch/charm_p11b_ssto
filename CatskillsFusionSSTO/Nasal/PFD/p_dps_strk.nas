...
var PFD_addpage_p_dps_strk = func(device)
{
	...
	p_dps_strk.reqd_id_y.setText("000");
	p_dps_strk.reqd_id_z.setText("000");
	...
	p_dps_strk.strk_dang_y.setText(sprintf("%+5.2f", angular_error * 0.7));
	p_dps_strk.strk_dang_z.setText(sprintf("%+5.2f", angular_error * -0.4));
	...
	if (track_id == 0)
		...
		{
		p_dps_strk.trk_id_y.setText(sprintf("%3d",track_id));
		}
	...
	if (track_id == 0)
		...
		{
		p_dps_strk.trk_id_z.setText(sprintf("%3d",track_id));
		}
	...
	if (track_id == 0)
		...
		{
		p_dps_strk.trk_id1.setText(sprintf("%3d",track_id));
		minutes = int((current_time - SpaceShuttle.star_table.time_stamp[0])/60.);
		p_dps_strk.trk_dmin1.setText(sprintf("%3d",minutes));
		p_dps_strk.angdif1.setText(sprintf("%5.1f",SpaceShuttle.star_table.ang_diff[0]));
		p_dps_strk.angerr1.setText(sprintf("%5.2f",SpaceShuttle.star_table.ang_err[0]));
		symbol = "";
	...
	if (track_id == 0)
		...
		{
		p_dps_strk.trk_id2.setText(sprintf("%3d",track_id));
		minutes = int((current_time - SpaceShuttle.star_table.time_stamp[1])/60.);
		p_dps_strk.trk_dmin2.setText(sprintf("%3d",minutes));
		p_dps_strk.angdif2.setText(sprintf("%5.1f",SpaceShuttle.star_table.ang_diff[1]));
		p_dps_strk.angerr2.setText(sprintf("%5.2f",SpaceShuttle.star_table.ang_err[1]));
		symbol = "";
	...
	if (track_id == 0)
		...
		{
		p_dps_strk.trk_id3.setText(sprintf("%3d",track_id));
		minutes = int((current_time - SpaceShuttle.star_table.time_stamp[2])/60.);
		p_dps_strk.trk_dmin3.setText(sprintf("%3d",minutes));
		p_dps_strk.angdif3.setText(sprintf("%5.1f",SpaceShuttle.star_table.ang_diff[2]));
		p_dps_strk.angerr3.setText(sprintf("%5.2f",SpaceShuttle.star_table.ang_err[2]));
		symbol = "";
	...
	else {p_dps_strk.reqd_id_coas.setText(sprintf("%3d", coas_star_id));}

	p_dps_strk.ddeg_x.setText(sprintf("%+4.1f",SpaceShuttle.coas.Ddeg_x));
	p_dps_strk.ddeg_y.setText(sprintf("%+4.1f",SpaceShuttle.coas.Ddeg_y));
	...
	p_dps_strk.dbias1.setText(sprintf("%4.2f", coas.Dbias_x) );
	p_dps_strk.dbias2.setText(sprintf("%4.2f", coas.Dbias_y) );
