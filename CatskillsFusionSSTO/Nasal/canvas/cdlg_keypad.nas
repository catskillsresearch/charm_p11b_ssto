var cdlg_keyboard = {
	...
	init: func {
		...
		var width = 330;
		var height = 512;
		var img_path = "Aircraft/CatskillsFusionSSTO/Dialogs/keypad.png";
		...
		var stack = [];
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_fault_sum.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_fault_sum_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_sys_sum.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_sys_sum_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_msg_reset.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_msg_reset_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_ack.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_ack_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_gpc_crt.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_gpc_crt_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_A.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_A_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_B.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_B_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_C.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_C_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_io_reset.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_io_reset_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_D.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_D_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_E.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_E_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_F.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_F_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_item.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_item_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_1.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_1_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_2.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_2_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_3.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_3_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_exec.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_exec_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_4.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_4_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_5.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_5_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_6.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_6_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_ops.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_ops_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_7.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_7_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_8.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_8_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_9.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_9_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_spec.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_spec_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_minus.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_minus_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_0.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_0_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_plus.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_plus_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_resume.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_resume_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_clear.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_clear_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_decimal.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_decimal_pressed.png");
		...
		setsize(stack,0);
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_pro.png");
		append(stack, "Aircraft/CatskillsFusionSSTO/Dialogs/keypad_pro_pressed.png");
