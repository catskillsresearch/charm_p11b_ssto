var cdlg_propellant = {
	...
	update_launch_dlg: func {
		...
		var content_et = getprop("/consumables/fuel/tank[3]/level-lbs") /1381428.6;
	...
	init_orbit_dlg: func {
		...
		me.fwd_rcs_text = cdlg_widget_property_label.new(me.root, "Forward RCS", text_color, outer_color, fill_color);
