...
var cdlg_rendezvous = {
	...
	init: func {
		...
		me.an_burn = me.root.createChild("text")
			...
			.setFontSize(14)
			.setFont("LiberationFonts/LiberationSans-Bold.ttf")
			.setTranslation(140, 60)
			.setAlignment("left-center");

		var obj_name = SpaceShuttle.proximity_manager.query_reference_name();

		me.an_ref_obj = me.root.createChild("text")
			.setText("Ref. object: "~obj_name)
			.setColor(0.0, 0.0, 0.0)
			.setFontSize(14)
			.setFont("LiberationFonts/LiberationSans-Bold.ttf")
			.setTranslation(140, 30)
			.setAlignment("left-center");

		me.an_ref_obj.enableUpdate();
	...
	update: func {
		...
		me.an_ref_obj.updateText("Ref. object: "~obj_name);
