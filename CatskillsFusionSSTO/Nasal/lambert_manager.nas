...
var lambert_manager = {
	...
	#Variable for "Lambert" display in mnvr page if Spec 34 converged 
	lambert_peg7: 0,
	...
	compute_to_t1: func {
		...
		SpaceShuttle.targeting_manager.set_acceleration(SpaceShuttle.oms_burn_target.accel_burn);
	...
	t2_finished: func {
		...
		#Set hash values for lambert peg7 dvx/y/z plan for mnvr.nas display of dvx/y/z if spec 34 converged

		SpaceShuttle.oms_burn_target.dvx_plan = SpaceShuttle.targeting_manager.dvx/0.3048;
		SpaceShuttle.oms_burn_target.dvy_plan = SpaceShuttle.targeting_manager.dvy/0.3048;
		SpaceShuttle.oms_burn_target.dvz_plan = SpaceShuttle.targeting_manager.dvz/0.3048;

		#Spec 34 converged / "Lambert" displayed in mnvr dps page

		lambert_manager.lambert_peg7 = 1;
	...
	show_t2: func {
		...
		if (me.cw_flag == 0)
			...
			if (SpaceShuttle.proximity_manager.iss_model == 0)
				...
				#Set hash values for cw peg7 dvx/y/z plan for mnvr.nas display of dvx/y/z if spec 34 converged

				SpaceShuttle.oms_burn_target.dvx_plan = SpaceShuttle.targeting_manager.dvx2/0.3048;
				SpaceShuttle.oms_burn_target.dvy_plan = -SpaceShuttle.targeting_manager.dvy2/0.3048;
				SpaceShuttle.oms_burn_target.dvz_plan = SpaceShuttle.targeting_manager.dvz2/0.3048;
	...
	interrupt: func {
		...
		SpaceShuttle.targeting_manager.kill_flag = 1;
		me.t1_in_progress = 0; 
		me.t2_in_progress = 0; 
		me.lock = 0;
	...
	lcw_chaser_to_t2_finished: func {
		...
		#Set hash values for cw peg7 dvx/y/z plan for mnvr.nas display of dvx/y/z if spec 34 converged
				...
				SpaceShuttle.oms_burn_target.dvx_plan = (SpaceShuttle.targeting_manager.target_prox_vx + vx_offset)/0.3048;
				SpaceShuttle.oms_burn_target.dvy_plan = SpaceShuttle.targeting_manager.target_prox_vy/0.3048;
				SpaceShuttle.oms_burn_target.dvz_plan = (SpaceShuttle.targeting_manager.target_prox_vz + vz_offset)/0.3048;
	...
	pa_search_finished: func {
		...
		var tshift  = 0.35 * math.abs(vy)/ SpaceShuttle.oms_burn_target.accel_burn;
