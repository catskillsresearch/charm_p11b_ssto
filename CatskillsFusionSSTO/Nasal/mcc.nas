...
SpaceShuttle.cdlg_notepad.take_note(string);
...
var time_to_go = (rei_now - 4000.0)*1853. / (getprop("/fdm/jsbsim/systems/entry_guidance/ground-relative-velocity-fps") * 0.3048);
