...
var targeting_manager = {
	...
	evolve: func (t) {
		...
		while ((me.t < t) and (me.check_condition() == 1) and (me.kill_flag == 0))
			{
			me.do_timestep();
	...
	evaluate_evolution: func {
		...
		if ( (me.evolution_finished == 0) and (((me.peg4_set == 1) and (me.peg4_fit_converged == 1)) or ((me.lambert_set == 1) and (me.lambert_fit_converged == 1))) or ((me.peg4_set == 0) and (me.lambert_set == 0)) )
			...
			{
			if ((me.peg4_fit_iterations > 50) or (me.lambert_fit_iterations > 50) or (me.kill_flag == 1))
				{
	...
	test_suite: func {
		...
		me.set_acceleration(SpaceShuttle.oms_burn_target.accel_burn);
