...
``../spacex_crew_dragon_seat.png`` — gpt56 variant.
...
Run::
    ...
    /snap/bin/blender -b -P seat/gpt56/build_gpt56.py

Outputs ``seat/gpt56/gpt56.blend`` and verification renders.
"""
...
BLEND_OUT = SEAT_DIR / "gpt56.blend"
PNG_OUT = SEAT_DIR / "gpt56_render.png"
PNG_OUT_SIDE = SEAT_DIR / "gpt56_render_side.png"
PNG_OUT_MOUNT = SEAT_DIR / "gpt56_render_mount.png"
...
def build_footrest(parent: bpy.types.Object, c_foot, mats) -> list[bpy.types.Object]:
    ...
    print(f"[gpt56] Footrest_Molded islands: {islands} "
